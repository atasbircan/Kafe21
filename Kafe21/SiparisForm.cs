...
namespace Kafe21
{
    public partial class SiparisForm : Form
    {
        ...
        public object Enumarable { get; private set; }
        ...
        public SiparisForm(KafeVeri kafeVeri, Siparis siparis)
        {
            ...
            MasaNolariGuncelle();
            // List<Urun> urunler = db.Urunler;

            UrunleriYukle();
            OdemeTutariGuncelle();
            SiparisDetaylarıYukle();
        }
        ...
        private void SiparisDetaylarıYukle()
        {
        ...
        private void btnAnasayfaya_Click(object sender, EventArgs e)
        {
            DialogResult = DialogResult.Cancel;// içinde bulunulan formun close metodunu çağırır.
        }
